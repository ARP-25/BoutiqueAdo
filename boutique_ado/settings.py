...
SECRET_KEY = 'django-insecure-ds-r0-&xlxnvhio57%@=1@c*!!+@e#f($ho*q%!y%v$v4=46x&'
...
# Tell Django where all static files are located
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'static'),)
# Tell Django where all media files are located
MEDIA_URL = '/media/'
...
# Added for counting delviery costs
